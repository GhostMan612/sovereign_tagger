...
## Phase 28 — Game-feel pass (visual FX, SFX, ghost 2.0, transitions) [x]
...
- [x] **28.3 Ghost brain** — offline, free: current-app knowledge, typo-tolerant matching, real commands, follow-ups
